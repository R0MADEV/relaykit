...
export class InMemoryShares {
  ...
  async startLocation(conversationId: ConversationId, input: ShareLocationInput): Promise<LiveLocation> {
  ...
  async updateLocation(sharingId: string, position: GeoLocation): Promise<void> {
  ...
  async stopLocation(sharingId: string): Promise<void> {
    const sharing = this.requireSharing(sharingId);
    this.locations.set(sharingId, { ...sharing, isLive: false });
  }

  async listLocations(conversationId: ConversationId): Promise<readonly LiveLocation[]> {
  ...
  async vote(pollId: MessageId, answerId: string): Promise<void> {
  ...
  async closePoll(pollId: MessageId): Promise<void> {
